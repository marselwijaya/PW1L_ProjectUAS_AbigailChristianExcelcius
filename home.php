  ...
  <body class="backAll" style="font-family:fontbody; overflow-x:hidden; font-size: 1.1em; color: white">
    <div class="content1">
        <video autoplay muted loop id="bgVideo">
          <source src="video/homevideobg.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <section class="part2home" id="Philosophy">
        <div class="part2text" data-aos="fade-left" style="transition:2s">
            <a class="linkpart" href="#Philosophy"><p>PHILOSOPHY</p></a>
        </div>
    </section>
    ...
    <div class="bawahS2"></div>

    <div class="bgpromo" id="Promo">
      <div class="part3text" data-aos="fade-left" style="transition:2s">
        <a class="linkpart" href="#Promo"><p>PROMO</p></a>
      </div>
